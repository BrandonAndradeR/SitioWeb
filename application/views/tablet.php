...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="imagen1" src="https://i.ytimg.com/vi/Yek5W41BIl0/maxresdefault.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="imagen2" src="https://miro.medium.com/max/2928/1*Tp38_H9KfJD_fGZlpIZjPA.jpeg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="imagen3" src="https://elandroidelibre.elespanol.com/wp-content/uploads/2018/07/MediaPad-M5-Lite-009.jpg" alt="Third slide">
    </div>
  </div>
...
<br>
<center><h1 style="color:greenyellow" class="news"><small>Apple iPad (7a Generación) </small></h1></center>
<br></br>
